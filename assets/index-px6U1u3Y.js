const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/editor-DwV0Sr5j.js","assets/editor-Dvl_Svmm.css"])))=>i.map(i=>d[i]);
(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function r(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(n){if(n.ep)return;n.ep=!0;const s=r(n);fetch(n.href,s)}})();const C="modulepreload",E=function(e){return"/"+e},b={},D=function(t,r,i){let n=Promise.resolve();if(r&&r.length>0){let I=function(a){return Promise.all(a.map(c=>Promise.resolve(c).then(m=>({status:"fulfilled",value:m}),m=>({status:"rejected",reason:m}))))};document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),l=o?.nonce||o?.getAttribute("nonce");n=I(r.map(a=>{if(a=E(a),a in b)return;b[a]=!0;const c=a.endsWith(".css"),m=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${a}"]${m}`))return;const d=document.createElement("link");if(d.rel=c?"stylesheet":C,c||(d.as="script"),d.crossOrigin="",d.href=a,l&&d.setAttribute("nonce",l),document.head.appendChild(d),c)return new Promise((z,y)=>{d.addEventListener("load",z),d.addEventListener("error",()=>y(new Error(`Unable to preload CSS for ${a}`)))})}))}function s(o){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=o,window.dispatchEvent(l),!l.defaultPrevented)throw o}return n.then(o=>{for(const l of o||[])l.status==="rejected"&&s(l.reason);return t().catch(s)})},P={title:"📍 Lernpfad – Gemini CLI",intro:"Dein strukturierter Weg von der Installation bis zum Profi-Einsatz.",steps:[{num:1,title:"Installation & Masterclass Video",desc:"Gemini CLI wird als globales npm-Paket installiert. Schau dir zuerst dieses Video an, um alle Funktionen von Gemini CLI im Überblick zu sehen.",youtube:"9xE2DTxGvTY",code:`npm install -g @google/gemini-cli
...
"hooks": { "SessionStart": [...] }`,lang:"json"},{step:"Parallel Agent Task",code:'claude "Use parallel agents to implement Feature A and B"',lang:"bash"}]}]},K={title:"🧪 Codelabs – Claude Code",intro:"Interaktive Praxis-Übungen direkt im Browser-Editor.",items:[{id:"lab-1",badge:"Anfänger",icon:"🎯",duration:"30 Min",title:"Codelab: Mein erster Claude-Edit",goal:"Lerne wie Claude Code Dateien liest, Änderungen vorschlägt und diese nach deiner Freigabe schreibt.",steps:[{title:"Datei erstellen",code:'echo "function add(a, b) { return a + b; }" > math.js',lang:"bash"},{title:"Claude beauftragen",code:'claude "Add documentation and input validation to math.js"',lang:"bash"},{title:"Resultat prüfen",code:"cat math.js",lang:"bash"}]},{id:"lab-2",badge:"Fortgeschritten",icon:"🔧",duration:"45 Min",title:"Codelab: Refactoring Legacy Code",goal:"Nutze Claude Code um ein altes Modul zu modernisieren und Tests hinzuzufügen.",steps:[{title:"Analyse",code:'claude "Explain the logic in legacy-module.js"',lang:"bash"},{title:"Modernisierung",code:'claude "Refactor legacy-module.js to use TypeScript and ES Modules"',lang:"bash"},{title:"Testing",code:'claude "Write unit tests for the refactored module and run them"',lang:"bash"}]}]},$={title:"📖 Tutorials – Claude Code",intro:"Best Practices, Tipps und vollständige Befehlsreferenz.",groups:[{title:"🧠 Mentale Modelle",items:[{title:"Vom Coder zum Architekten",icon:"🤝",content:"Betrachten Sie Claude Code als einen extrem schnellen Junior-Entwickler. Sie geben die Richtung vor, Claude führt aus.",tips:["Seien Sie spezifisch bei Anweisungen","Reviewen Sie jeden Diff sorgfältig","Nutzen Sie CLAUDE.md für dauerhafte Regeln"]}]},{title:"⌨️ CLI Referenz",items:[{title:"Alle Befehle auf einen Blick",icon:"⌨️",content:"Die wichtigsten Kommandozeilen-Befehle und ihre Wirkung.",table:[["Befehl","Beschreibung"],["claude","Interaktive REPL starten"],['claude -p "Prompt"',"Einmalige Antwort (Headless)"],["claude -c","Letzte Sitzung fortsetzen"],["claude commit","Geführter Commit-Dialog"],["claude mcp add","Neuen MCP Server hinzufügen"],["claude skill add","Neuen Skill hinzufügen"]]},{title:"Keyboard Shortcuts",icon:"⚡",content:"Produktivitäts-Shortcuts in der REPL.",table:[["Shortcut","Aktion"],["Ctrl+C","Abbrechen / Leeren"],["Ctrl+D","Beenden"],["Shift+Tab","Thinking Mode umschalten"],["↑ / ↓","Befehls-Historie"]]}]}]},N={title:"🧠 CodeWiki – Claude Code",intro:"Das ultimative Glossar für alle Begriffe rund um Claude Code.",categories:[{name:"Grundlagen",items:[{term:"Agentic Coding",definition:"Die Fähigkeit der KI, aktiv Code zu schreiben, Tests auszuführen und Shell-Befehle zu nutzen, um ein Ziel zu erreichen."},{term:"REPL",definition:"Read-Eval-Print-Loop: Die interaktive Kommandozeilen-Schnittstelle von Claude Code."},{term:"Diff",definition:"Der Unterschied zwischen dem aktuellen Code und der von Claude vorgeschlagenen Änderung."}]},{name:"Konzepte & Files",items:[{term:"CLAUDE.md",definition:"Die zentrale Konfigurationsdatei für projektweite Anweisungen, Coding-Styles und Architektur-Regeln."},{term:"settings.json",definition:"Globale Konfigurationsdatei für Benutzerpräferenzen wie Themes, Modelle und Berechtigungen."},{term:"MCP",definition:"Model Context Protocol – Ein offener Standard zur Anbindung externer Tools an KI-Modelle."}]},{name:"Security & Control",items:[{term:"Permission Mode",definition:"Sicherheitsstufen (default, plan, power), die festlegen, wie oft Claude nach Erlaubnis fragen muss."},{term:"Sandbox",definition:"Eine isolierte Umgebung, in der Claude riskante Befehle sicher ausführen kann."}]}]},F={title:"📍 Lernpfad – Google Antigravity IDE",intro:"Willkommen in der Zukunft der Softwareentwicklung. Antigravity ist keine einfache IDE, sondern ein Ökosystem aus autonomen KI-Agenten, die deine Projekte steuern.",steps:[{num:1,title:"Installation & Setup",desc:"Lade die Antigravity IDE herunter und verbinde deinen Google-Account für den Zugriff auf Gemini 3 Pro.",code:`# Antigravity ist eine Desktop-App (Windows, macOS, Linux)
# Nach der Installation:
# 1. Öffne Antigravity
# 2. Gehe zu Mission Control
# 3. Verbinde deinen Google Cloud Account`,lang:"text",chips:[{label:"Download IDE",url:"https://antigravity.google/"},{label:"Cloud Setup",url:"https://console.cloud.google.com/"},{label:"Offizielles Codelab",url:"https://codelabs.developers.google.com/getting-started-google-antigravity?hl=de#0"}]},{num:2,title:"Mission Control & Workspaces",desc:"In Mission Control verwaltest du deine Agenten. Erstelle deinen ersten Workspace für ein bestehendes oder neues Projekt.",code:`// In der UI:
// Datei > Neuer Workspace > Lokalen Ordner wählen
// Der Agent beginnt sofort mit der Indizierung deiner Codebase.`,lang:"text"},{num:3,title:"Der erste Agent-Task",desc:"Weise dem Agenten eine komplexe Aufgabe zu. Er wird einen Plan erstellen, den du reviewen kannst.",code:`// Prompt in der Agent-Leiste:
// "Migriere das gesamte Projekt von Webpack zu Vite und fix alle daraus resultierenden Fehler."`,lang:"text"}]},V={title:"📦 Antigravity Konzepte",intro:'Verstehe, wie die agent-first Architektur funktioniert. Für tiefgehende Informationen besuche auch das <a href="https://codelabs.developers.google.com/getting-started-google-antigravity?hl=de#0" target="_blank" class="link">offizielle Google Antigravity Codelab</a>.',groups:[{title:"🤖 Die Agent-Architektur",items:[{title:"Agent-First Paradigm",icon:"🧠",content:"Im Gegensatz zu Copilots, die Vorschläge machen, arbeiten Antigravity Agenten autonom über Datei-, Terminal- und Browser-Grenzen hinweg.",tips:["Agenten können Aufgaben planen und selbst verifizieren","Nutze den Mission Control Tab zur Überwachung","Delegiere komplexe Refactorings"]},{title:"Mission Control (Dashboard)",icon:"🚀",content:"Das zentrale Dashboard zur Orchestrierung mehrerer Agenten, die parallel an verschiedenen Aufgaben arbeiten.",code:`In Mission Control siehst du:
- Aktive Tasks
- Generierte Artifacts
- Browser-Recording der Agenten-Aktionen`,lang:"text"}]},{title:"🛡️ Sicherheit & Kontrolle",items:[{title:"Autonomy Policies",icon:"🛡️",content:'Bestimme, wie viel Freiheit dein Agent hat. Du kannst zwischen Profilen wie "Review-driven development" (hohe Kontrolle) und "Full Autonomy" wählen.',tips:["Nutze Allowlists für harmlose Shell-Befehle (ls, git status)","Setze Denylists für gefährliche Befehle (rm -rf, sudo)","Agenten fragen immer nach, bevor sie nicht-autorisierte Befehle ausführen"]},{title:"Shell Permissions",icon:"🐚",content:"Verwalte detailliert, welche Terminal-Befehle ein Agent autonom ausführen darf, um die Sicherheit deines Systems zu gewährleisten.",code:`# Beispiel für eine Policy-Konfiguration:
{
  "allowed_commands": ["npm test", "git log"],
  "require_approval": ["npm install", "rm"]
}`,lang:"json"}]},{title:"🌐 Web-Integration",items:[{title:"Browser Sub-Agent",icon:"🌍",content:"Antigravity verfügt über einen spezialisierten Browser-Agenten, der das Web durchsuchen, Dokumentationen lesen und Web-UIs testen kann.",tips:["Der Agent kann Screenshots und Video-Recordings von UI-Tests erstellen","Ideal für Visual Regression Testing","Kann Dokumentationen direkt von GitHub oder offiziellen API-Docs lesen"]}]},{title:"🤝 Kollaboration mit Agenten",items:[{title:"Interactive Artifacts",icon:"📄",content:"Agenten liefern strukturierte Ergebnisse wie Task-Listen, Implementation Plans und Walkthroughs.",tips:["Nutze Google-Docs-Style Kommentare in Blueprints","Ändere Pläne ab, bevor der Agent mit der Implementierung beginnt","Walkthroughs erklären dir Schritt für Schritt, was der Agent geändert hat"]}]},{title:"📄 Artifacts & Planung",items:[{title:"Implementation Plans (Blueprints)",icon:"🗺️",content:"Bevor ein Agent Code schreibt, erstellt er einen detaillierten Plan. Du kannst diesen Plan kommentieren oder anpassen.",code:`1. Analyse der package.json
2. Installation von Vite
3. Konfiguration der vite.config.ts
4. Validierung der Imports`,lang:"text"},{title:"Artifacts & Verification",icon:"✅",content:"Agenten liefern greifbare Artifacts (Pläne, Testberichte, Screenshots). Sie nutzen den integrierten Browser, um Web-UIs zu verifizieren.",tips:["Reviewe Pläne vor der Ausführung","Prüfe Screenshots bei UI-Änderungen","Nutze die Rewind-Funktion bei Fehlern"]}]},{title:"🛠️ Erweiterungen",items:[{title:"Agent Skills (SKILL.md)",icon:"⚡",content:"Erweitere die Fähigkeiten deiner Agenten durch Skills. Diese werden on-demand geladen, um das Kontextfenster zu schonen.",code:`# SKILL.md
description: API-Integration-Spezialist
---
Fokus auf REST/GraphQL Patterns...`,lang:"markdown"}]}]},O={title:"🎓 Antigravity Masterclass",intro:"Werde zum Agenten-Orchestrator.",items:[{id:"ag-master",badge:"Experte",icon:"🏆",title:"Autonome Feature-Entwicklung",duration:"45 Min",description:"Lerne, wie du eine komplette End-to-End Funktion nur durch Agenten-Steuerung bauen lässt.",lernziele:["Agent-Briefing optimieren","Multi-Step Pläne reviewen","Self-Healing Prozesse steuern"],content:[{step:"Briefing & Planung",code:'"Baue ein User-Dashboard mit Auth-Integration und Unit-Tests."',lang:"text"},{step:"Review & Ausführung",code:'Prüfe den generierten Blueprint und klicke auf "Apply Plan".',lang:"text"}]}]},W={title:"🧪 Antigravity Labs",intro:"Interaktive Experimente in der IDE.",items:[{id:"lab-ag-ui",badge:"Fortgeschritten",icon:"🌐",duration:"30 Min",title:"Visual Regression Lab",goal:"Lasse den Agenten ein CSS-Refactoring durchführen und die UI mittels Browser-Verification testen.",steps:[{title:"CSS Refactor Task",code:'"Mache die UI responsive und nutze CSS Variables."',lang:"text"},{title:"Browser Verification",code:"Der Agent öffnet den integrierten Browser und prüft Breakpoints.",lang:"text"}]}]},H={title:"📖 Dokumentation",intro:"Alles über die Konfiguration von Antigravity.",groups:[{title:"Konfiguration",items:[{title:"Agent Rules (.agent/rules)",icon:"📜",content:"Definiere projektweite Regeln, an die sich alle Agenten halten müssen (z.B. Codestil).",code:`# .agent/rules/style.md
- Nutze immer Early Returns
- Dokumentiere public Methoden in JSDoc`,lang:"markdown"}]}]},U={title:"📚 Antigravity Wiki",intro:"Wichtige Begriffe der Agent-IDE.",categories:[{name:"IDE Konzepte",items:[{term:"Mission Control",definition:"Das Dashboard zur Agenten-Verwaltung."},{term:"Artifact",definition:"Strukturiertes Output-Dokument eines Agenten."},{term:"Agent Skill",definition:"Modulare Fähigkeit, die on-demand geladen wird."},{term:"Self-Healing",definition:"KI-Prozess zur automatischen Fehlerkorrektur."}]}]},_={title:"GitHub Copilot Lernpfad",description:"Meistere KI-gestützte Entwicklung von den Basics bis zu fortgeschrittenen Extensions und Agents.",steps:[{id:1,title:"Copilot in VS Code einrichten",status:"completed"},{id:2,title:"Effektives Prompting & Context",status:"not-started"},{id:3,title:"Copilot Chat & Slash Commands",status:"not-started"},{id:4,title:"Unit Tests & Refactoring mit KI",status:"not-started"},{id:5,title:"Copilot Extensions & Custom Agents",status:"not-started"}]},J=[{id:"m1",title:"Einstieg & Konfiguration",courses:[{id:"c101",title:"Installation & Authentifizierung",type:"course"},{id:"c102",title:"Die wichtigsten Shortcuts im Editor",type:"course"},{id:"c103",title:"Datenschutz & Telemetrie-Einstellungen",type:"course"}]},{id:"m2",title:"Copilot Chat & Interaktion",courses:[{id:"c201",title:"Slash Commands: /fix, /tests, /explain",type:"course"},{id:"c202",title:"@workspace: Projektweites Verständnis",type:"course"},{id:"c203",title:"Inline Chat vs. Sidepanel",type:"course"}]},{id:"m3",title:"Fortgeschrittene Workflows",courses:[{id:"c301",title:"Automatisierte Dokumentation",type:"course"},{id:"c302",title:"Legacy Code Refactoring",type:"course"},{id:"c303",title:"Copilot in der CLI nutzen",type:"course"}]}],Z=[{id:"k1",title:"Copilot for Power Users",level:"Intermediate"},{id:"k2",title:"AI-Driven Architecture",level:"Advanced"}],Y=[{id:"cl1",title:"Test-Driven Development mit Copilot",topic:"Testing",duration:"30 min"},{id:"cl2",title:"Regex & Algorithmen generieren",topic:"Logic",duration:"15 min"},{id:"cl3",title:"Migration von JS zu TypeScript",topic:"Migration",duration:"45 min"}],Q=[{id:"t1",title:"Copilot mit JetBrains IDEs nutzen",category:"IDE"},{id:"t2",title:"GitHub Copilot Enterprise Features",category:"Enterprise"},{id:"t3",title:"Custom Instructions für Copilot",category:"Customization"}],q=[{term:"Copilot Chat",definition:"Ein interaktives Chat-Interface direkt in der IDE für komplexe Fragen und Refactorings."},{term:"Ghost Text",definition:"Die hellgrauen Code-Vorschläge, die Copilot während des Tippens direkt im Editor anzeigt."},{term:"Slash Commands",definition:"Kurzbefehle wie /fix oder /explain, um gezielte KI-Aktionen im Chat auszulösen."},{term:"@workspace",definition:"Ein Agent im Chat, der Zugriff auf das gesamte Projekt hat, um kontextrelevante Antworten zu geben."},{term:"@terminal",definition:"Ein Agent, der hilft, passende Shell-Commands für das aktuelle Betriebssystem zu finden."},{term:"Prompt Engineering",definition:"Die Kunst, Anweisungen so zu formulieren, dass die KI das präziseste Ergebnis liefert."},{term:"Context Window",definition:"Die Menge an Code und Informationen, die Copilot gleichzeitig 'betrachten' kann."}],X={title:"📍 Lernpfad – Java Development",intro:'Vom ersten "Hello World" bis zu komplexen Applikationen. Dieser Pfad führt dich durch die Grundlagen der Java-Programmierung.',steps:[{num:1,title:"JDK Setup & IDE",desc:"Bevor du Java-Code schreiben kannst, benötigst du das Java Development Kit (JDK) und eine Entwicklungsumgebung (IDE).",code:`# Überprüfe, ob Java bereits installiert ist:
java -version
javac -version`,lang:"bash",chips:[{label:"Oracle JDK Download",url:"https://www.oracle.com/java/technologies/downloads/"},{label:"IntelliJ IDEA",url:"https://www.jetbrains.com/idea/"},{label:"VS Code Java Pack",url:"https://marketplace.visualstudio.com/items?itemName=vscjava.vscode-java-pack"}]},{num:2,title:"Schreiben, Kompilieren, Ausführen",desc:"Verstehe den Workflow: Du schreibst Quellcode (.java), kompilierst ihn zu Bytecode (.class) und führst diesen in der JVM aus.",code:`// 1. Datei erstellen: Hello.java
public class Hello {
...
// java Hello`,lang:"java"},{num:3,title:"Grundlegende Syntax",desc:"Lerne Variablen, Datentypen und Operatoren kennen – die Bausteine jedes Programms.",code:`int alter = 25;
double preis = 19.99;
boolean istAktiv = true;
String name = "Gemini";

int summe = 10 + 5;
boolean vergleich = (alter > 18);`,lang:"java"}]},ee={title:"📦 Java Module",intro:"Detaillierte Module zu den Kernkonzepten von Java.",groups:[{title:"⚙️ Grundlagen & Setup",items:[{title:"JDK & IDE Installation",icon:"🛠️",content:"Installiere das JDK (z.B. OpenJDK oder Oracle JDK) und wähle eine IDE wie IntelliJ IDEA, Eclipse oder VS Code für effizientes Arbeiten.",tips:["Nutze SDKMAN! auf Linux/macOS zur JDK-Verwaltung","IntelliJ IDEA ist der Industriestandard für Java","Vergewissere dich, dass JAVA_HOME in den Umgebungsvariablen gesetzt ist"]},{title:"Der Java-Zyklus",icon:"🔄",content:"Java ist eine kompilierte Sprache. Der Compiler `javac` erzeugt plattformunabhängigen Bytecode, den die Runtime `java` ausführt.",code:`javac MeinProgramm.java  // Erzeugt MeinProgramm.class
java MeinProgramm        // Startet die JVM`,lang:"bash"}]},{title:"🔡 Daten & Operatoren",items:[{title:"Variablen & Datentypen",icon:"📊",content:"Java unterscheidet zwischen primitiven Typen (int, double, boolean, etc.) und Referenztypen (Objekte, Strings, Arrays).",code:`// Primitiv
int zahl = 42;
char buchstabe = 'A';
...
// Konstanten
final double PI = 3.14159;`,lang:"java"},{title:"Operatoren",icon:"➕",content:"Nutze arithmetische (+, -, *, /), relationale (==, !=, <, >) und logische (&&, ||, !) Operatoren für Berechnungen und Bedingungen.",code:`int a = 10, b = 3;
int rest = a % b; // Modulo: 1

boolean check = (a > 5) && (b < 5); // true`,lang:"java"}]},{title:"🛤️ Kontrollfluss",items:[{title:"Verzweigungen (if/switch)",icon:"⚖️",content:"Steuere den Programmablauf basierend auf Bedingungen.",code:`if (score > 90) {
...
}`,lang:"java"},{title:"Schleifen (Loops)",icon:"🔁",content:"Wiederhole Aufgaben effizient mit for, while oder do-while Schleifen.",code:`// For-Schleife (Zählschleife)
for (int i = 0; i < 5; i++) {
...
}`,lang:"java"},{title:"2. Zuweisung über eine Setze-Methode (Setter)",icon:"🔧",content:"Das ist nützlich, wenn ein Bauteil erst später hinzugefügt werden soll oder wenn man es während des Betriebs einmal austauschen möchte.",code:`public class AnzeigeDienst {
...
}`,lang:"java"},{title:"Zusammenfassung",icon:"📊",content:"Hier siehst du die Unterschiede auf einen Blick:",table:[["Weg","Wann nutzen?","Vorteile"],["Konstruktor","Für wichtige Teile","Sicher und fest verbaut"],["Setze-Methode","Für Wahlfreies","Kann man später ändern"]]}]},{title:"🌐 Web & Persistence",items:[{title:"Spring Data JPA",icon:"💾",content:"Abstraktionsschicht für Datenbankzugriffe. Erstelle Repositories einfach per Interface.",code:`public interface UserRepository extends JpaRepository<User, Long> {
  List<User> findByLastName(String name);
}`,lang:"java"}]}]},ye={title:"🎓 Kurse",intro:"Strukturierte Lerneinheiten für Spring Boot.",items:[{id:"spring-1",badge:"Anfänger",icon:"🍃",duration:"30 Min",title:"Spring Boot Quickstart",description:'Erstelle deine erste "Hello World" Anwendung in 5 Minuten.',lernziele:["Spring Initializr nutzen","Ersten Controller schreiben","Anwendung starten"],content:[{step:"Projekt generieren",code:`https://start.spring.io/
Dependencies: Spring Web, DevTools`,lang:"text"},{step:"Controller erstellen",code:`@RestController
public class HelloController {
  @GetMapping("/")
  public String index() { return "Greetings from Spring Boot!"; }
}`,lang:"java"}]}]},Ce={title:"🧪 Codelabs",intro:"Praxis-Übungen für Spring Boot.",items:[{id:"lab-sb-1",badge:"Mittel",icon:"🛠️",duration:"45 Min",title:"REST API mit H2 & JPA",goal:"Baue ein komplettes Backend für eine ToDo-Liste.",steps:[{title:"Entity definieren",code:`@Entity
public class Todo {
  @Id @GeneratedValue Long id;
  String task;
  boolean done;
}`,lang:"java"}]}]},Ee={title:"📖 Tutorials",intro:"Deep-Dives in spezielle Spring Boot Themen.",groups:[{title:"Security",items:[{title:"Spring Security Basics",icon:"🔐",content:"Sichere deine Endpunkte mit Form-Login oder JWT."}]}]},De={title:"📚 CodeWiki",intro:"Glossar für Spring Boot Fachbegriffe.",categories:[{name:"Core",items:[{term:"IoC Container",definition:"Der Kern von Spring, der Objekte (Beans) instanziiert und verwaltet."},{term:"@Autowired",definition:"Annotation zur automatischen Injektion von Abhängigkeiten."}]}]},Pe={title:"AI Toolkit Mastery Lernpfad",description:"Lerne, wie du lokale KI-Modelle (SLMs) direkt in VS Code ausführst, testest und in deine Projekte integrierst.",steps:[{id:1,title:"AI Toolkit Installation & Setup",status:"completed"},{id:2,title:"Model Catalog & Lokales Downloaden",status:"not-started"},{id:3,title:"Model Playground: Prompts lokal testen",status:"not-started"},{id:4,title:"Feintuning & Optimierung von Modellen",status:"not-started"},{id:5,title:"Integration in Applikationen (REST API & SDKs)",status:"not-started"}]},Me=[{id:"m1",title:"Einstieg & Hardware",courses:[{id:"c101",title:"Installation der VS Code Extension",type:"course"},{id:"c102",title:"GPU-Beschleunigung einrichten (CUDA/DirectML)",type:"course"},{id:"c103",title:"Unterschiede: Cloud vs. Local LLMs",type:"course"}]},{id:"m2",title:"Modell-Management",courses:[{id:"c201",title:"Einführung in Phi-3, Llama 3 & Mistral",type:"course"},{id:"c202",title:"Modelle finden im Hugging Face Hub",type:"course"},{id:"c203",title:"Quantisierung verstehen (Q4_K_M vs FP16)",type:"course"}]},{id:"m3",title:"Entwicklung & Integration",courses:[{id:"c301",title:"Der lokale REST-Server des Toolkits",type:"course"},{id:"c302",title:"Nutzen von OpenAI-kompatiblen APIs",type:"course"},{id:"c303",title:"AI Toolkit in Python & C# nutzen",type:"course"}]}],Te=[{id:"k1",title:"SLM Deployment on Edge Devices",level:"Advanced"},{id:"k2",title:"Optimizing Prompts for Small Language Models",level:"Intermediate"}],xe=[{id:"cl1",title:"Chat-App mit lokalem Phi-3 Modell",topic:"Integration",duration:"25 min"},{id:"cl2",title:"Performance-Benchmarking verschiedener Modelle",topic:"Performance",duration:"20 min"},{id:"cl3",title:"RAG-System (Retrieval Augmented Generation) lokal",topic:"Architecture",duration:"50 min"}],je=[{id:"t1",title:"Hardware-Anforderungen für lokale KI",category:"Hardware"},{id:"t2",title:"Sicherheit: KI ohne Internetverbindung",category:"Security"},{id:"t3",title:"Modell-Konvertierung nach ONNX",category:"Optimization"}],Be=[{term:"SLM (Small Language Model)",definition:"KI-Modelle mit weniger Parametern (z.B. Phi-3), die effizient auf lokaler Hardware laufen."},{term:"Quantisierung",definition:"Reduzierung der Genauigkeit von Modellgewichten (z.B. von 16-Bit auf 4-Bit), um Speicherplatz und Rechenpower zu sparen."},{term:"Hugging Face",definition:"Die größte Plattform für Open-Source KI-Modelle und Datensätze."},{term:"Local Inference",definition:"Das Ausführen von KI-Berechnungen direkt auf dem eigenen PC statt in der Cloud."},{term:"ONNX Runtime",definition:"Eine performante Engine von Microsoft zum Ausführen von optimierten KI-Modellen."},{term:"DirectML",definition:"Eine DirectX-basierte API zur Beschleunigung von KI auf Windows-Hardware."},{term:"Model Playground",definition:"Ein interaktives Interface im AI Toolkit zum schnellen Testen von Prompts und Modell-Parametern."}],Ge={title:"📍 Lernpfad – Google AI Studio",intro:"Der schnellste Weg von der Idee zum ersten Gemini-API Call. Lerne, wie du Prompts perfektionierst und in Code verwandelst.",steps:[{num:1,title:"Einstieg & Interface",desc:"Melde dich mit deinem Google-Konto an und erkunde das Interface. Erfahre, wo du Modelle wählst und Einstellungen vornimmst.",youtube:"9xE2DTxGvTY",code:`# Öffne im Browser:
...
`;let u=localStorage.getItem("topic")||"gemini";const h={gemini:{title:"Gemini CLI",install:"npm install -g @google/gemini-cli",content:{lernpfad:P,module:M,kurse:T,codelabs:x,tutorials:j,codewiki:B}},"claude-spa":{title:"Claude Code (Basic)",install:"curl -fsSL https://claude.ai/install.sh | bash",content:{lernpfad:G,module:L,kurse:R,codelabs:K,tutorials:$,codewiki:N}},antigravity:{title:"Google Antigravity",install:"https://antigravity.google/",content:{lernpfad:F,module:V,kurse:O,codelabs:W,tutorials:H,codewiki:U}},copilot:{title:"GitHub Copilot",install:"https://github.com/features/copilot",content:{lernpfad:_,module:J,kurse:Z,codelabs:Y,tutorials:Q,codewiki:q}},java:{title:"Java Development",install:"https://www.oracle.com/java/technologies/downloads/",content:{lernpfad:X,module:ee,kurse:ne,codelabs:te,tutorials:ie,codewiki:re}},javascript:{title:"JavaScript Fullstack",install:"https://nodejs.org/",content:{lernpfad:se,module:oe,kurse:ae,codelabs:le,tutorials:de,codewiki:ce}},csharp:{title:"C# Programming",install:"https://dotnet.microsoft.com/download/csharp",content:{lernpfad:ue,module:ge,kurse:me,codelabs:he,tutorials:pe,codewiki:fe}},aspnetcore:{title:"ASP.NET Core",install:"dotnet new webapi",content:{lernpfad:be,module:ke,kurse:ve,codelabs:Se,tutorials:we,codewiki:Ae}},springboot:{title:"Spring Boot",install:"https://start.spring.io/",content:{lernpfad:Ie,module:ze,kurse:ye,codelabs:Ce,tutorials:Ee,codewiki:De}},aitoolkit:{title:"AI Toolkit for VS Code",install:"code --install-extension ms-windows-ai-studio.windows-ai-studio",content:{lernpfad:Pe,module:Me,kurse:Te,codelabs:xe,tutorials:je,codewiki:Be}},aistudio:{title:"Google AI Studio",install:"https://aistudio.google.com/",content:{lernpfad:Ge,module:Le,kurse:Re,codelabs:Ke,tutorials:$e,codewiki:Ne}}};window.switchTopic=function(e){u=e,localStorage.setItem("topic",e),document.body.setAttribute("data-topic",e),document.getElementById("sidebar-title").textContent=h[e].title,document.title=`${h[e].title} Learning Portal`,window.location.hash="home",p()};document.body.setAttribute("data-topic",u);window.addEventListener("DOMContentLoaded",()=>{const e=document.getElementById("topic-select");e&&(e.value=u),document.getElementById("sidebar-title").textContent=h[u].title});function g(){return h[u].content}function f(e,t="bash"){return`<div class="code-block">
    ...
    </div>`}function A(e=null){const t=g().codelabs;if(e){const i=t.items.find(s=>s.id===e);if(!i)return A();const n=i.steps.map((s,o)=>`
            <div class="lab-step">
    ...
    </section>`}window.navigate=function(e,t=null){window.location.hash=t?`${e}/${t}`:e};window.copyCode=function(e){const t=e.closest(".code-block").querySelector("code").innerText;navigator.clipboard.writeText(t).then(()=>{e.textContent="✅ Kopiert!",setTimeout(()=>e.textContent="📋 Kopieren",2e3)})};window.injectToEditor=function(e){const t=e.closest(".code-block").querySelector("code").innerText;if(window.editorInstance){window.editorInstance.setValue(t);const r=document.getElementById("editor-wrapper");r&&r.scrollIntoView({behavior:"smooth"})}else alert("Editor lädt noch...")};function Ye(){const e=window.location.hash.substring(1)||"home",[t,r]=e.split("/");return{section:t,subId:r||null}}function Qe(e,t){switch(e){case"lernpfad":return He();case"module":return Ue();case"kurse":return S(t);case"codelabs":return A(t);case"tutorials":return _e();case"codewiki":return Je();case"impressum":return qe();case"datenschutz":return Xe();default:return Ze()}}function qe(){return Fe}function Xe(){return Ve}function p(){const{section:e,subId:t}=Ye(),r=document.getElementById("app");r&&(r.innerHTML=Qe(e,t),window.scrollTo(0,0),document.querySelectorAll(".nav-links a").forEach(i=>{const n=i.getAttribute("href").replace("#","");i.classList.toggle("active",n===e)}),document.getElementById("editor-container")&&en())}window.addEventListener("hashchange",p);window.addEventListener("load",p);async function en(){const e=document.getElementById("editor-container");if(e){e.innerHTML='<div style="padding:20px;color:#94a3b8;">Lädt Editor...</div>';try{const{init:t}=await D(async()=>{const{init:r}=await import("./editor-DwV0Sr5j.js").then(i=>i.b);return{init:r}},__vite__mapDeps([0,1]));t(e)}catch(t){console.error("Editor Fehler:",t)}}}window.addEventListener("DOMContentLoaded",()=>{localStorage.getItem("cookies-accepted")||setTimeout(()=>{const e=document.getElementById("cookie-banner");e&&e.classList.add("show")},1e3)});window.acceptCookies=function(){localStorage.setItem("cookies-accepted","true"),window.closeCookieBanner(),typeof p=="function"&&p()};window.renderYouTube=function(e){return localStorage.getItem("cookies-accepted")==="true"?`<iframe class="youtube-video" 
        ...
        </div>`};window.closeCookieBanner=function(){const e=document.getElementById("cookie-banner");e&&e.classList.remove("show")};export{D as _};
